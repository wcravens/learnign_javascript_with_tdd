...
describe( 'Objects', function() {
  ...
  it( 'is always passed by referene (not a copy)', function() {
    var myObject = { propertyKey: 'value' };
    (function alterMyObject( obj ) { obj.propertyKey = 'newValue'; })( myObject );
    expect( myObject.propertyKey ).to.equal( 'newValue' );
  } );
